 ...
 */
package com.wecook.uikit.widget.indicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public void setRight(boolean mRighted) {
        this.mRighted = mRighted;
        invalidate();
    }
...
//        }
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        int index = position;
        if (mPageCount != 0) {
            index = position % mPageCount;
        }
        if (!(index == mPageCount - 1 && positionOffset > 0)) {
            invalidate();
        }
