...
package com.wecook.uikit.widget.datetimepicker.time;
...
import com.wecook.uikit.widget.datetimepicker.Utils;
        ...
        switch(event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mIsTouchingAmOrPm == AM || mIsTouchingAmOrPm == PM) {
                    ...
                    boolean forceLegal = Utils.isJellybeanOrLater()? mAccessibilityManager.isTouchExplorationEnabled():false;
