...
import com.wecook.uikit.widget.photoview.gestures.GestureDetector;
import com.wecook.uikit.widget.photoview.gestures.OnGestureListener;
import com.wecook.uikit.widget.photoview.gestures.VersionedGestureDetector;
import com.wecook.uikit.widget.photoview.scrollerproxy.ScrollerProxy;
...
public class PhotoViewAttacher implements IPhotoView, View.OnTouchListener,
    ...
    public Bitmap getVisibleRectangleBitmap() {
        ImageView imageView = getImageView();
        Bitmap bitmap = imageView == null ? null : imageView.getDrawingCache();
        if (bitmap != null) {
            byte[] bytes = BitmapUtils.bitmap2Bytes(bitmap, 100);
            Bitmap byteBitmap = BitmapFactory.decodeByteArray(bytes, 0, bytes.length);
            Bitmap targetBitmap = Bitmap.createBitmap(byteBitmap, 0, 0, mIvRight - mIvLeft, mIvBottom - mIvTop);

            BitmapUtils.clean(bitmap);
            bytes = null;
            return targetBitmap;
