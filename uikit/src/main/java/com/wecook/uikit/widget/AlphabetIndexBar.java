...
public class AlphabetIndexBar extends LinearLayout {
	...
	public void setContentView() {
		...
		LinearLayout layout = (LinearLayout) ((Activity) mContext)
				.getLayoutInflater().inflate(R.layout.uikit_alphabet_indexbar, null);
	...
	private void setupViews() {
		mLayoutIndex = (LinearLayout) this.findViewById(R.id.uikit_alphabet_index);
	...
	private OnTouchListener layoutIndexTouchListener = new OnTouchListener() {
		@Override
	...
	public void setSelectedColor() {
		this.setBackgroundColor(getResources().getColor(R.color.uikit_grey_light));
	}
	...
	public void setNormalColor() {
		this.setBackgroundColor(getResources().getColor(R.color.uikit_transparent));
	}
}
