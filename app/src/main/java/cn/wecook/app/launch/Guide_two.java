 ...
 */
public class Guide_two extends GuideBaseFragment {
    /**
     * 动画执行时间
     */
    ...
    private boolean isRightScroll;//是否页面向右滑
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (contentView == null) {
            contentView = inflater.inflate(R.layout.fragment_guide_two, null);
        }
        return contentView;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        initAnimation();
        imgView = (ImageView) view.findViewById(R.id.app_guide_two_img);
        checkboxView = (ImageView) view.findViewById(R.id.app_guide_two_checkbox);
        textView = (ImageView) view.findViewById(R.id.app_guide_two_text);
    }
