...
public class RequestManager implements LifecycleListener {
    ...
    /**
     * Sets an interface that can apply some default options to all Requests started using this {@link com.bumptech.glide.RequestManager}.
     *
     * <p>
    ...
    /**
     * Returns true if loads for this {@link com.bumptech.glide.RequestManager} are currently paused.
     *
     * @see #pauseRequests()
     * @see #resumeRequests()
     */
     ...
     * @return A {@link com.bumptech.glide.RequestManager.GenericModelRequest} to set options for the load and ultimately the target to load the model
     * into.
     */
     ...
     * @param <T> The type of the model.
     * @return A new {@link com.bumptech.glide.RequestManager.ImageModelRequest}.
     */
     ...
     * @param modelLoader The model loader to use.
     * @param <T> The type of the model.
     * @return A new {@link com.bumptech.glide.RequestManager.VideoModelRequest}.
     */
    ...
    /**
     * Use the {@link com.bumptech.glide.load.model.ModelLoaderFactory} currently registered for {@link java.io.File} to load
     * the image represented by the given {@link java.io.File}. Defaults to
    ...
    /**
     * Use the {@link com.bumptech.glide.load.model.ModelLoaderFactory} currently registered for {@link java.net.URL} to load the
     * image represented by the given {@link java.net.URL}. Defaults to
     ...
     * for {@link java.io.InputStream}s and {@link ParcelFileDescriptor}s to load a thumbnail from either the image or the video
