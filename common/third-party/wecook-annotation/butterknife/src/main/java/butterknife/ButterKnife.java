 ...
 * }
 * </code></pre>
 * Injection can be performed directly on an {@linkplain #inject(android.app.Activity) activity}, a
 * {@linkplain #inject(android.view.View) view}, or a {@linkplain #inject(android.app.Dialog) dialog}. Alternate objects to
 * inject can be specified along with an {@linkplain #inject(Object, android.app.Activity) activity},
 * {@linkplain #inject(Object, android.view.View) view}, or
 * {@linkplain #inject(Object, android.app.Dialog) dialog}.
 * <p>
 * Group multiple views together into a {@link java.util.List} or array.
 * <pre><code>
 ...
 * <ul>
 * <li>{@link #apply(java.util.List, butterknife.ButterKnife.Action)} &ndash; Applies an action to each view.</li>
 * <li>{@link #apply(java.util.List, butterknife.ButterKnife.Setter, Object)} &ndash; Applies a setter value to each view.</li>
 * <li>{@link #apply(java.util.List, android.util.Property, Object)} &ndash; Applies a property value to each view.</li>
 * </ul>
 * <p>
 ...
 * If a view is optional add the {@link butterknife.Optional @Optional} annotation.
 * <pre><code>
 * {@literal @}Optional @InjectView(R.id.title) TextView subtitleView;
 * </code></pre>
 *
 * @see butterknife.InjectView
 * @see butterknife.InjectViews
 * @see butterknife.OnCheckedChanged
 * @see butterknife.OnClick
 * @see butterknife.OnEditorAction
 * @see butterknife.OnFocusChange
 * @see butterknife.OnItemClick
 * @see butterknife.OnItemLongClick
 * @see butterknife.OnItemSelected
 * @see butterknife.OnLongClick
 * @see butterknife.OnPageChange
 * @see butterknife.OnTextChanged
 * @see butterknife.OnTouch
 */
public final class ButterKnife {
  ...
  /**
   * Inject annotated fields and methods in the specified {@link android.app.Activity}. The current content
  ...
  /**
   * Inject annotated fields and methods in the specified {@link android.view.View}. The view and its children
  ...
  /**
   * Inject annotated fields and methods in the specified {@link android.app.Dialog}. The current content
   * view is used as the view root.
   *
   ...
   * {@link android.app.Activity} as the view root.
   *
  ...
  /**
   * Inject annotated fields and methods in the specified {@code target} using the {@code source}
   * {@link android.view.View} as the view root.
   *
   * @param target Target class for field injection.
  ...
  /**
   * Inject annotated fields and methods in the specified {@code target} using the {@code source}
   * {@link android.app.Dialog} as the view root.
   *
   * @param target Target class for field injection.
  ...
  /**
   * Reset fields annotated with {@link butterknife.InjectView @InjectView} and {@link butterknife.InjectViews @InjectViews}
   * to {@code null}.
   * <p>
  ...
  /** Simpler version of {@link android.app.Dialog#findViewById(int)} which infers the target type. */
  @SuppressWarnings({ "unchecked", "UnusedDeclaration" }) // Checked by runtime cast. Public API.
