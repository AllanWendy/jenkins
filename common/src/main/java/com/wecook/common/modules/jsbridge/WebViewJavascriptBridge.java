...
public class WebViewJavascriptBridge {
    ...
    public void _handleMessageFromJs(String data, String responseId,
        ...
        Logger.d(TAG, "data:" + data + " responseId:" + responseId
                + " responseData:" + responseData + " callbackId:" + callbackId
        ...
        if (null != responseId) {
            ...
            if (null != handlerName) {
                ...
                if (null == handler) {
                    Logger.e(TAG, "WVJB Warning: No handler for " + handlerName);
                    return;
                }
            } else {
            ...
            try {
                ...
                Logger.e(TAG, "WebViewJavascriptBridge: WARNING: java handler threw. " + exception.getMessage());
            }
        }
    }
    ...
    private void dispatchMessage(Map<String, Object> message) {
        ...
        Logger.d(TAG, "dispatchMessage sending:" + javascriptCommand);
